...
os.chdir("/blue/arthur.porto-biocosmos/mlurig/git-repos/unicom/")
...
data_clust = pd.read_csv(r"/blue/arthur.porto-biocosmos/mlurig/projects/2024_nymphalidae/data/clusters_assignments_mod.csv")

data_clust = data_clust.sort_values(by=["species"])
data_clust["class"] = data_clust["species"].astype('category').cat.codes
